...
async function run() {
    try {
        ...
        // analytics or stats related api
        app.get('/admin-stats', verifyToken, verifyAdmin, async (req, res) => {
            ...
            const revenue = result.length > 0 ? Number(result[0].totalRevenue).toFixed(2) : 0;
...
app.get('/', (req, res) => {
    res.send('Boss is waiting for your response')
});
